...
CREATE TABLE "new_dialogue_lines" (
    ...
    "leftMoodId" TEXT,
    "rightMoodId" TEXT,
    "displayedCharacterActive" BOOLEAN NOT NULL DEFAULT false,
    "leftCharacterActive" BOOLEAN NOT NULL DEFAULT false,
    "rightCharacterActive" BOOLEAN NOT NULL DEFAULT false,
    "displayedMoodActive" BOOLEAN NOT NULL DEFAULT false,
    "leftMoodActive" BOOLEAN NOT NULL DEFAULT false,
    "rightMoodActive" BOOLEAN NOT NULL DEFAULT false,
...
INSERT INTO "new_dialogue_lines" ("characterId", "dialogueId", "displayedCharacterId", "displayedMoodId", "id", "leftCharacterId", "leftMoodId", "order", "rightCharacterId", "rightMoodId", "text") SELECT "characterId", "dialogueId", "displayedCharacterId", "displayedMoodId", "id", "leftCharacterId", "leftMoodId", "order", "rightCharacterId", "rightMoodId", "text" FROM "dialogue_lines";
